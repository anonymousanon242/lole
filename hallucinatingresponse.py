...
class HallucinatedResponse:
    ...
    def get_gpt2_response(self, prompt):
        ...
        outputs = model.generate(inputs, max_length=500, num_return_sequences=1, temperature=2.0, top_p=0.5, do_sample=True)
    ...
    def get_gpt3_response(self, prompt):
        ...
        completion = client.chat.completions.create(
            model="gpt-3.5-turbo",
            messages=[
                {"role": "system", "content": "Your task is to generate responses"},
    ...
    def get_cerebras_response(self, prompt):
        ...
        output = pipe(prompt, max_length=500, do_sample=True, temperature=2.0, top_p=0.5, no_repeat_ngram_size=2)
